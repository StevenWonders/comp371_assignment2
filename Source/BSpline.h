...
public:
	...
	static glm::vec3 GetTangentVector(float t, const glm::vec3& p1, const glm::vec3& p2, const glm::vec3& p3, const glm::vec3& p4);
	static glm::vec3 GetAccelerationVector(float t, const glm::vec3& p1, const glm::vec3& p2, const glm::vec3& p3, const glm::vec3& p4);

    // @TODO - add method(s) returning the tangent vector on the spline
	glm::vec3 GetTangentVector(float t);
	glm::vec3 GetAccelerationVector(float t);
