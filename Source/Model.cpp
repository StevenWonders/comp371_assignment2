...
void Model::Update(float dt)
{
	...
	else if (mSpline)
	{
		...
		//std::cout<<mName.c_str() << ": T=" <<mSplineParameterT <<std::endl;
		//std::cout<<mName.c_str() << ": T=" <<mSpline->mSplineParameterT <<std::endl;
...
void Model::SetRotation2(glm::vec3 axis, float angleDegrees)
{
	mRotationAxis2 = axis;
	mRotationAngleInDegrees2 = angleDegrees;
}
