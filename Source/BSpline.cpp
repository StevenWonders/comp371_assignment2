...
glm::vec3 BSpline::GetTangentVector(float t) {
	...
	return vec3(GetWorldMatrix() * vec4(BSpline::GetTangentVector(t - (int) t, mControlPoints[p1], mControlPoints[p2], mControlPoints[p3], mControlPoints[p4]), 0.0f));

}

glm::vec3 BSpline::GetTangentVector(float t, const vec3& p1, const vec3& p2, const vec3& p3, const vec3& p4)
{
    // Returns the position of the object on the spline
    // based on parameter t and the four control points p1, p2, p3, p4
...
glm::vec3 BSpline::GetAccelerationVector(float t) {
	...
	return vec3(GetWorldMatrix() * vec4(BSpline::GetAccelerationVector(t - (int) t, mControlPoints[p1], mControlPoints[p2], mControlPoints[p3], mControlPoints[p4]), 0.0f));

}

glm::vec3 BSpline::GetAccelerationVector(float t, const vec3& p1, const vec3& p2, const vec3& p3, const vec3& p4)
{
    // Returns the position of the object on the spline
    // based on parameter t and the four control points p1, p2, p3, p4
